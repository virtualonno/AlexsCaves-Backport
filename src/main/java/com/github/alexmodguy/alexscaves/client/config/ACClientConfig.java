...
public class ACClientConfig {
    ...
    public ACClientConfig(final ForgeConfigSpec.Builder builder) {
        ...
        renderingOffsetFixes = builder.comment("if you experience tremosaurus or forsaken is looks like floating or stuck in ground while hitbox is normal, try change this value").define("renderingOffsetFixes", false);
        builder.pop();
        builder.push("audio");
