...
public class NuclearFurnaceRecipeCategory implements IRecipeCategory<AbstractCookingRecipe> {
    ...
    @Override
    public void draw(AbstractCookingRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack guiGraphics, double mouseX, double mouseY) {
        drawExperience(recipe, guiGraphics, 0);
        drawCookTime(recipe, guiGraphics, 50);
    }

    protected void drawExperience(AbstractCookingRecipe recipe, PoseStack guiGraphics, int y) {
        ...
        if (experience > 0) {
            ...
            Screen.drawString(guiGraphics, fontRenderer, experienceString, getWidth() - stringWidth, y, 0xFF808080);
        }
    }

    protected void drawCookTime(AbstractCookingRecipe recipe, PoseStack guiGraphics, int y) {
        ...
        if (cookTime > 0) {
            ...
            Screen.drawString(guiGraphics, fontRenderer, timeString, getWidth() - stringWidth, y, 0xFF808080);
        }
    }
