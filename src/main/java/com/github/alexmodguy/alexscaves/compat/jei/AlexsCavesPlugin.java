...
public class AlexsCavesPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        if(Minecraft.getInstance().level != null){
            ...
            abstractCookingRecipeList.addAll(Minecraft.getInstance().level.getRecipeManager().getAllRecipesFor((net.minecraft.world.item.crafting.RecipeType<AbstractCookingRecipe>) NuclearFurnaceBlockEntity.getRecipeType()));
