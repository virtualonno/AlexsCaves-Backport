...
public class PewenPinesBlock extends BushBlock {
    ...
    public PewenPinesBlock() {
        super(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT, DyeColor.GREEN).instabreak().sound(SoundType.ROOTS).randomTicks().offsetType(BlockBehaviour.OffsetType.XZ).noOcclusion().noCollission());
    }
