...
public class ForsakenEntity extends Monster implements IAnimatedEntity, ShakesScreen {
            ...
            if (this.getAnimation() == ANIMATION_GROUND_SMASH) {
                ...
                if (this.getAnimationTick() == 12) {
                    ...
                    for (int i1 = 0; i1 < particleCount; i1++) {
                        ...
                        BlockPos ground = new BlockPos(ACMath.getGroundBelowPosition(level, new Vec3(Mth.floor(smashPos.x + extraX), Mth.floor(smashPos.y + extraY) + 2, Mth.floor(smashPos.z + extraZ))));
    ...
    public boolean hurt(DamageSource damageSource, float f) {
        if (damageSource.msgId.equals("sonic_boom")) {
