...
public class AcidSwimNodeEvaluator extends SwimNodeEvaluator {
    ...
    @Override
    public BlockPathTypes getBlockPathType(BlockGetter getter, int x, int y, int z, Mob p_77476_, int p_77477_, int p_77478_, int p_77479_, boolean p_77480_, boolean p_77481_) {
