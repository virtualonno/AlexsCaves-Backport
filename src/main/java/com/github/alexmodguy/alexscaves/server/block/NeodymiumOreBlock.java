...
public class NeodymiumOreBlock extends Block {
    ...
    public NeodymiumOreBlock(boolean azure) {
        super(BlockBehaviour.Properties.of(Material.STONE, DyeColor.WHITE).requiresCorrectToolForDrops().strength(3.5F, 10.0F).sound(ACSoundTypes.NEODYMIUM).lightLevel((i) -> 3).emissiveRendering((state, level, pos) -> true));
        this.azure = azure;
    }
