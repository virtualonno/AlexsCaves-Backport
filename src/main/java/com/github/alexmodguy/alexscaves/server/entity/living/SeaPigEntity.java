...
public class SeaPigEntity extends WaterAnimal implements Bucketable {
    ...
    private void digestItem() {
        if (!level.isClientSide) {
            ...
            List<ItemStack> items = loottable.getRandomItems((new LootContext.Builder((ServerLevel) this.level)).withParameter(LootContextParams.THIS_ENTITY, this).create(LootContextParamSets.PIGLIN_BARTER));
