...
public class ArchaicVineBlock extends GrowingPlantHeadBlock {
    ...
    public ArchaicVineBlock() {
        super(BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.COLOR_GREEN).randomTicks().noCollission().instabreak().sound(SoundType.VINE), Direction.DOWN, SHAPE, false, 0.1D);
    }
