...
public class ACSoundTypes {
    ...
    public static final SoundType PEWEN_BRANCH = new ForgeSoundType(1.0F, 1.0F, () -> ACSoundRegistry.PEWEN_BRANCH_BREAK.get(), () -> SoundEvents.WOOD_STEP, () -> SoundEvents.WOOD_PLACE, () -> SoundEvents.WOOD_HIT, () -> SoundEvents.WOOD_FALL);
    public static final SoundType FLOOD_BASALT = new ForgeSoundType(1.0F, 1.0F, () -> ACSoundRegistry.FLOOD_BASALT_BREAK.get(), () -> ACSoundRegistry.FLOOD_BASALT_STEP.get(), () -> ACSoundRegistry.FLOOD_BASALT_PLACE.get(), () -> ACSoundRegistry.FLOOD_BASALT_BREAKING.get(), () -> ACSoundRegistry.FLOOD_BASALT_STEP.get());
    ...
    public static final SoundType TUBE_WORM = new ForgeSoundType(1.0F, 1.0F, () -> ACSoundRegistry.TUBE_WORM_BREAK.get(), () -> ACSoundRegistry.TUBE_WORM_STEP.get(), () -> ACSoundRegistry.TUBE_WORM_PLACE.get(), () -> ACSoundRegistry.TUBE_WORM_BREAKING.get(), () -> ACSoundRegistry.TUBE_WORM_STEP.get());
