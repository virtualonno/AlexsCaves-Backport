...
public class HologramProjectorBlockEntity extends BlockEntity {
            ...
            if (entity.displayEntity == null && !entity.isPlayerRender()) {
                if (entity.switchProgress > 0.0F) {
                    if(entity.switchProgress == 10.0F){
                        level.playSound((Player)null, blockPos, ACSoundRegistry.HOLOGRAM_STOP.get(), SoundSource.BLOCKS, 1.0F, 1.0F);
                    }
    ...
    public void setRemoved() {
        ...
        level.playSound((Player)null, this.getBlockPos(), ACSoundRegistry.HOLOGRAM_STOP.get(), SoundSource.BLOCKS, 1.0F, 1.0F);
        super.setRemoved();
    }
}
