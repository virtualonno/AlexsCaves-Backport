...
public abstract class DinosaurEntity extends TamableAnimal implements IDancesToJukebox, LaysEggs {
    ...
    public void onLayEggTick(BlockPos belowEgg, int time) {
        ...
        this.animationSpeed += (0.5 - this.animationSpeed) * 0.4F;
    ...
    public void handleEntityEvent(byte b) {
        if (b == 77) {
            ...
            for (int i1 = 0; i1 < particleCount; i1++) {
                ...
                BlockPos ground = new BlockPos(ACMath.getGroundBelowPosition(level, new Vec3(Mth.floor(this.getX() + extraX), Mth.floor(this.getY() + extraY), Mth.floor(this.getZ() + extraZ))));
