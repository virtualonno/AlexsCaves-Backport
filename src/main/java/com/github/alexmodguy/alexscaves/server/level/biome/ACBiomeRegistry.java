...
public class ACBiomeRegistry {
    ...
    public static final ResourceKey<Biome> TOXIC_CAVES = ResourceKey.create(Registry.BIOME_REGISTRY, new ResourceLocation(AlexsCaves.MODID, "toxic_caves"));
    public static final ResourceKey<Biome> ABYSSAL_CHASM = ResourceKey.create(Registry.BIOME_REGISTRY, new ResourceLocation(AlexsCaves.MODID, "abyssal_chasm"));
    public static final ResourceKey<Biome> FORLORN_HOLLOWS = ResourceKey.create(Registry.BIOME_REGISTRY, new ResourceLocation(AlexsCaves.MODID, "forlorn_hollows"));
