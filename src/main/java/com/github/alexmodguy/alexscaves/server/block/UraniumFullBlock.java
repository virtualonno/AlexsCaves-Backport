...
public class UraniumFullBlock extends RotatedPillarBlock {
    ...
    public UraniumFullBlock() {
        super(Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_GREEN).strength(3.5F).lightLevel((state -> 4)).emissiveRendering((state, level, pos) -> true).sound(ACSoundTypes.URANIUM));
    }
