...
public class SemiAquaticPathNavigatorNoSpin extends SemiAquaticPathNavigator {
    ...
    public SemiAquaticPathNavigatorNoSpin(Mob entitylivingIn, Level worldIn) {
        super(entitylivingIn, worldIn);
    }

    public SemiAquaticPathNavigatorNoSpin(Mob entitylivingIn, Level worldIn, float distancemodifier) {
        super(entitylivingIn, worldIn);
