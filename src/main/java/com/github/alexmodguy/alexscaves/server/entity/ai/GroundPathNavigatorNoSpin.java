...
public class GroundPathNavigatorNoSpin extends GroundPathNavigation {
    ...
    public GroundPathNavigatorNoSpin(Mob entitylivingIn, Level worldIn) {
        super(entitylivingIn, worldIn);
    }

    public GroundPathNavigatorNoSpin(Mob entitylivingIn, Level worldIn, float distancemodifier) {
        super(entitylivingIn, worldIn);
