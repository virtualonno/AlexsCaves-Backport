...
public class UnrefinedWasteBlock extends FallingBlockWithColor {
    ...
    public UnrefinedWasteBlock() {
        super(BlockBehaviour.Properties.of(Material.SAND, DyeColor.LIME).strength(0.5F).sound(ACSoundTypes.UNREFINED_WASTE).lightLevel(state -> 3).emissiveRendering((state, level, pos) -> true), 0X00EE00);
    }
