...
public class ACSurfaceRuleConditionRegistry {
    ...
    public static final DeferredRegister<Codec<? extends SurfaceRules.ConditionSource>> DEF_REG = DeferredRegister.create(Registry.CONDITION_REGISTRY, AlexsCaves.MODID);
