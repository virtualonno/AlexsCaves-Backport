...
public class NuclearFurnaceMenu extends AbstractContainerMenu {
    ...
    private boolean canSmelt(ItemStack stack) {
        return this.level.getRecipeManager().getRecipeFor((RecipeType<AbstractCookingRecipe>)NuclearFurnaceBlockEntity.getRecipeType(), new SimpleContainer(stack), this.level).isPresent();
    }
