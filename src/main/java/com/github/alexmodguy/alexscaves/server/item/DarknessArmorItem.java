...
public class DarknessArmorItem extends ArmorItem implements CustomArmorPostRender, KeybindUsingArmor, UpdatesStackTags {
    ...
    public DarknessArmorItem(ArmorMaterial armorMaterial, EquipmentSlot slot) {
        super(armorMaterial, slot, new Properties().rarity(ACItemRegistry.RARITY_DEMONIC).tab(ACCreativeTabRegistry.FORLORN_HOLLOWS));
    }
